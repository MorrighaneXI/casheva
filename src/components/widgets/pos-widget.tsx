                    ...
                    <div className="rounded-2xl border border-sidebar-border/80 bg-card p-4 shadow-card">
                        ...
                        <div className="flex items-center gap-2 overflow-x-auto pt-3 pb-1 scrollbar-none">
                            <button
                                ...
                                className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${selectedKategori === "ALL"
                            ...
                            {kategoriProdukList.map((kat) => (
                                <button
                                    ...
                                    className={`px-3 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${selectedKategori === kat.id
                                            ? "bg-primary text-primary-foreground shadow-sm"
                                            : "bg-muted text-muted-foreground hover:bg-accent hover:text-accent-foreground"
                                        }`}
                                >
                        ...
                        {filteredProduk.map((prod) => {
                            ...
                            return (
                                <div
                                    ...
                                    className={`group relative flex flex-col justify-between rounded-xl border p-3 transition-all duration-200 cursor-pointer overflow-hidden ${isStokHabis
                                ...
                                >
                                    ...
                                    <div className="mt-2.5 pt-2 border-t border-border/60 flex items-center justify-between text-[11px]">
                                        <span
                                            className={`font-medium ${isStokHabis
                                                    ? "text-destructive"
                                                    : isStokMenipis
                    ...
                    <div className="space-y-4 pt-2">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            <button
                                ...
                                className={`p-3 rounded-xl border text-center transition-all flex flex-col items-center gap-1.5 ${metodeBayar === "TUNAI"
                            ...
                            <button
                                ...
                                className={`p-3 rounded-xl border text-center transition-all flex flex-col items-center gap-1.5 ${metodeBayar === "QRIS"
                                        ? "border-primary bg-primary/10 text-primary font-bold shadow-sm"
                                        : "border-border hover:bg-muted text-muted-foreground font-medium"
                                    }`}
                            >
                            ...
                            <button
                                ...
                                className={`p-3 rounded-xl border text-center transition-all flex flex-col items-center gap-1.5 ${metodeBayar === "KREDIT_TEMPO"
                                        ? "border-primary bg-primary/10 text-primary font-bold shadow-sm"
                                        : "border-border hover:bg-muted text-muted-foreground font-medium"
                                    }`}
                            >
                                                ...
                                                {[1, 3, 6].map((t) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={`p-2.5 rounded-xl border text-center transition-all ${tenorKredit === t
                                                                    ? "border-primary bg-primary/10 text-primary font-bold shadow-sm"
