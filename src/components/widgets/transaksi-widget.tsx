            ...
            <Dialog open={!!selectedTx} onOpenChange={(o) => !o && setSelectedTx(null)}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Detail transaksi tercatat pada sistem pembukuan SISKOPAD Sistem Koperasi TNI AD
                        </DialogDescription>
                    </DialogHeader>
                    {selectedTx && (
