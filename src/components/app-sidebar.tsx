                        ...
                        return (
                          <SidebarMenuItem key={item.title}>
                            <SidebarMenuButton
                              ...
                              isActive={active}
                              tooltip={item.title}
                              className={`transition-all duration-150 rounded-lg text-xs py-1.5 h-8.5 ${
                                active
      ...
      <SidebarFooter className="border-t border-sidebar-border p-2.5">
        {!collapsed ? (
          <div className="flex items-center justify-between text-[10px] text-sidebar-foreground/60 px-1">
            <span>Casheva v2.5</span>
            <span className="flex items-center gap-1 text-emerald-400 font-medium">
              <span className="size-1.5 rounded-full bg-emerald-400 animate-pulse" /> Real-time Live
            </span>
          </div>
        ) : (
